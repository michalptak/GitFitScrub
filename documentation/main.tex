...
\paragraph{Tytuł zadania.} Udostępnianie wyniku podsumowania treningu na portalu społecznościowym.
\paragraph{Opis zadania.} Dodanie przycisku udostępnij w panelu podsumowanie, który wywołuje metodę wysłającą dane o treningu na portal społecznościowy.
\paragraph{Priorytet.} 3.
...
\paragraph{Priorytet.} 3.
\paragraph{Definition of Done.} Po przebiegnięciu określonego czasu/dystansu użytkownikownik usłyszy alert dźwiękowy.
