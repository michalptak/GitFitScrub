...
\par Demostracja przyrostu produktu.
    ...
    \begin{figure}[H]
	\centering
	\includegraphics[height=0.6\textwidth]{img/history2.png}
	\includegraphics[height=0.6\textwidth]{img/postWorkoutMap.png}\\
	{Widok ekranu historia oraz mapy po zakończonym treningu. }
    \end{figure}
